package com.ran.qxlinechart.webview;
 ...
 * android WebView详解
 * 灵感来源:http://blog.csdn.net/self_study/article/details/54928371
 */
public class WRWebView extends WebView {
    ...
    public WRWebView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public WRWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
