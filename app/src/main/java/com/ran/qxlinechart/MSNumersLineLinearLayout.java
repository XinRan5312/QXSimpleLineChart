 ...
 */
public class MSNumersLineLinearLayout extends LinearLayout{

    int mLeft, mRight, mTop, mBottom;
    Hashtable map = new Hashtable();

    public MSNumersLineLinearLayout(Context context) {
        super(context);
    }

    public MSNumersLineLinearLayout(Context context, int horizontalSpacing, int verticalSpacing) {
        super(context);
    }

    public MSNumersLineLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
